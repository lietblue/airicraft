...
public final class ActionFactPersistencePolicy {
	...
	public static ActionFactDurability durability(ActionFact fact) {
		...
		return switch (fact.identity().type()) {
			...
			case INVENTORY_ITEM, INVENTORY_RESOURCE, INVENTORY_TOOL, CRAFT_RECIPE, SMELT_RECIPE, SMELTING_PROCESS, WATCH_PENDING, ROUTE_FAILURE -> ActionFactDurability.VOLATILE;
		};
	}
